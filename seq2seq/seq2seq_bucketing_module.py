...
"""A `Seq2SeqBucketingModule` implements the `BaseModule` API, and allows multiple
...
from mxnet.module.base_module import BaseModule, _check_input_names
from mxnet.module import Module

class Seq2SeqBucketingModule(BaseModule):
    ...
    def __init__(self, sym_gen, default_bucket_key=None, logger=logging,
        ...
        super(Seq2SeqBucketingModule, self).__init__(logger=logger)
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
             ...
             grad_req='write'):
        """Binding for a `Seq2SeqBucketingModule` means setting up the buckets and bind the
        ...
        force_rebind : bool
            Default is `False`.
        shared_module : Seq2SeqBucketingModule
        ...
        assert shared_module is None, 'shared_module for Seq2SeqBucketingModule is not supported'
